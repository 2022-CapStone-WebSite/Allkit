...
<head>
	...
	<style>
        ...
        h5{font-size:30px; text-align:right; float:right; font-weight:bold; padding:0 30%;} 
...
<br><br><br><br><br><br>
		<h2 class="bold">베스트</h2>
<br><br>
<a href="/shop/lowPrice"><h5 id="b">낮은가격순</h5></a>
...
<br>  
	...
	<a href = "/shop/view?n=${best.gdsNum}">
	<img src="${best.gdsImg }" class="rounded float-start set" alt="..."  style="width : 30%; margin-right:10px"  >
	</a>    
	<br>  	
	<a href = "/shop/view?n=${best.gdsNum}" ><span id = "sug">${best.gdsName }</span></a>
	<br>  
	<a href = "/shop/view?n=${best.gdsNum }"><span id = "sug4">${best.gdsPrice }원</span></a>
	<br> 	
	<span id = "sug4">평점:${best.ratingAvge}</span>  
	<br>
	<span>카테고리 :${best.cateName }</span>
