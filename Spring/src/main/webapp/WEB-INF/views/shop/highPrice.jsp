...
<br>  
	<c:forEach items="${high}" var = "high">
	<a href = "/shop/view?n=${high.gdsNum}">
	<img src="${high.gdsImg }" class="rounded float-start set" alt="..."  style="width : 30%; margin-right:10px"  >
	</a>    
	<br>  	
	<a href = "/shop/view?n=${high.gdsNum}" ><span id = "sug">${high.gdsName}</span></a>
	<br>  
	<a href = "/shop/view?n=${high.gdsNum }"><span id = "sug4">${high.gdsPrice}원</span></a>
	<br> 	
	<span id = "sug4">평점:${high.ratingAvge}</span>
	<br>
	<span>카테고리 :${high.cateName }</span>
